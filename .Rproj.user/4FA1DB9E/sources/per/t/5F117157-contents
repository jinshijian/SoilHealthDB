...
pdf( paste(outputs_loc,'0-1. Soil health backgroud information histgram.pdf', sep = "/" ), width=6, height=4)
...
pdf( paste(outputs_loc,'0-2. Soil health indicator histgram.pdf', sep = "/" ), width=8, height=4)
